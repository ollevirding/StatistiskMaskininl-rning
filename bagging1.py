...
model = BaggingClassifier(estimator=skl_da.QuadraticDiscriminantAnalysis(), n_estimators=200, oob_score = True)
...
traincompletex_norm = inputNormalization(traincompletex,traincompletex)[0]
model.fit(traincompletex_norm, traincompletey)
'''
